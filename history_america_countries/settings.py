"""
Django settings for history_america_countries project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'history-america-countries.up.railway.app']
...
ROOT_URLCONF = 'history_america_countries.urls'
...
WSGI_APPLICATION = 'history_america_countries.wsgi.application'
